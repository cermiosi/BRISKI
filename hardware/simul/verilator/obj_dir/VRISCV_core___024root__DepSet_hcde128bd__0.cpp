...
VL_INLINE_OPT void VRISCV_core___024root___nba_sequent__TOP__0(VRISCV_core___024root* vlSelf) {
    ...
    vlSelf->RISCV_core__DOT__ALUOp = ((4U & (IData)(vlSelf->RISCV_core__DOT__ALUctrl))
                                       ? ((2U & (IData)(vlSelf->RISCV_core__DOT__ALUctrl))
                                           ? 0U : (
                                                   (1U 
                                                   ...
                                                   ((0U 
                                                    ...
                                                    ((1U 
                                                     ...
                                                     : 0U)))
                                       : ((2U & (IData)(vlSelf->RISCV_core__DOT__ALUctrl))
                                           ? ((1U & (IData)(vlSelf->RISCV_core__DOT__ALUctrl))
                                               ? 0xaU
                                               : ((0x4000U 
                                                   & vlSelf->RISCV_core__DOT__instr_reg_inst__DOT__pipeline_stages)
                                                   ? 
